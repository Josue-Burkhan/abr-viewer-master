...
namespace AK.Abr
{
    ...
    {
        public IAbrSource Source { get; }

        public AbrReader(IAbrSource source) {
            Source = source ?? throw new ArgumentNullException(nameof(source));
        }

        private void ReadCore(CancellationToken cancellationToken) {
            ...
            using (var fs = Source.OpenRead()) {
                ...
                switch (ver) {
                    ...
                    case 9:
                    case 10:
                        this.ReadVer6(ebr, cancellationToken);
                        break;
        ...
        private static BitmapSource CreateImage(int width, int height, byte[] buffer, CancellationToken cancellationToken) {
            var bitmap = new WritableBitmapImage(width, height);
            bitmap.Lock();
        ...
        private void ReadVer12(EndianBinaryReader ebr, int ver, CancellationToken cancellationToken) {
            ...
            for (int i = 0; i < num; i++) {
                ...
                switch (num3) {
                    ...
                    case 2: {
                        ...
                        var image = CreateImage(width, height, buffer, cancellationToken);
        ...
        private void ReadVer6(EndianBinaryReader ebr, CancellationToken cancellationToken) {
            int width = 0;
            int height = 0;
            int num3 = ebr.ReadInt16();
            ebr.ReadBytes(8);
